...
from app.api.v1.endpoints.athlete_insights import router as athlete_insights_router
...
from app.api.v1.endpoints.coach_insights import router as coach_insights_router
...
api_router.include_router(athlete_insights_router)
api_router.include_router(athlete_self_router)
api_router.include_router(coach_insights_router)
